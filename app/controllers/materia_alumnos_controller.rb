class MateriaAlumnosController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to materia_alumnos_path, status: :see_other, notice: "Materia alumno was successfully destroyed." }
  ...
  private
    ...
    def materia_alumno_params
      params.expect(materia_alumno: [ :materia_docente_id, :alumno_id ])
    end
end
