class AsistenciaGeneralsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @asistencia_general.update(asistencia_general_params)
        format.html { redirect_to @asistencia_general, notice: "Asistencia general was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to asistencia_generals_path, notice: "Asistencia general was successfully destroyed.", status: :see_other }
