class Ability
  ...
  def docente_rules(user)
    ...
    # 👇 Agregamos esto para permitir la acción personalizada :planilla
    can :planilla, AsistenciaMateria
    can :planilla, MateriaDivision, materia_docentes: { docente_id: user.id }
  end
