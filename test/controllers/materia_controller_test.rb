...
class MateriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materium" do
    assert_difference("Materium.count") do
      post materia_url, params: { materium: { ciclo_lectivo_id: @materium.ciclo_lectivo_id, curso_id: @materium.curso_id, docente_id: @materium.docente_id, nombre: @materium.nombre, orientacion_id: @materium.orientacion_id, turno_id: @materium.turno_id } }
    end
  ...
  test "should update materium" do
    patch materium_url(@materium), params: { materium: { ciclo_lectivo_id: @materium.ciclo_lectivo_id, curso_id: @materium.curso_id, docente_id: @materium.docente_id, nombre: @materium.nombre, orientacion_id: @materium.orientacion_id, turno_id: @materium.turno_id } }
