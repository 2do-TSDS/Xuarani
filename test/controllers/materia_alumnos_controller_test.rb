...
class MateriaAlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materia_alumno" do
    assert_difference("MateriaAlumno.count") do
      post materia_alumnos_url, params: { materia_alumno: { alumno_id: @materia_alumno.alumno_id, materia_id: @materia_alumno.materia_id } }
    end
  ...
  test "should update materia_alumno" do
    patch materia_alumno_url(@materia_alumno), params: { materia_alumno: { alumno_id: @materia_alumno.alumno_id, materia_id: @materia_alumno.materia_id } }
